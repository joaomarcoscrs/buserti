          ...
          <div class="table-slack">
            <v-tooltip top>
                ...
                <div v-if="selected_employee.device">
                  <span>Sistema Atual: {{selected_employee.device.os_atual}}</span> <br />
                  <span>Sistema Original: {{selected_employee.device.os_original}}</span> <br />
                  <span>Garantia: {{selected_employee.device.garantia_expira}}</span> <br />
                  <span>Observações: {{selected_employee.device.observacoes}}</span> <br />
                  <span>Tag de serviço: {{selected_employee.device.service_tag}}</span> <br />
                </div>
              </v-tooltip>
          </div>
        </div>
